...
const Login = () => {
  ...
  const { login, verifyLogin, googleLogin } = useContext(AuthContext);
        ...
        <div className="w-full max-w-md px-4 sm:px-6 relative z-10">
          <div className="bg-white/10 lg:bg-transparent backdrop-blur-xl lg:backdrop-blur-none border border-white/20 lg:border-transparent p-8 sm:p-10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] lg:shadow-none">
            ...
            {!otpStep ? (
              ...
              <form className="space-y-5" onSubmit={otpSubmitHandler}>
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1.5 ml-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-11 pr-4 py-3.5 bg-slate-900/50 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all text-center tracking-[0.5em] font-bold text-xl"
                      placeholder="••••••"
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center px-1">
                  ...
                  <button
                    ...
                    className="text-sm font-bold text-amber-400 hover:text-amber-300 transition-colors disabled:text-slate-500 disabled:cursor-not-allowed"
                  >
