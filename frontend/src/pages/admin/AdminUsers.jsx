...
const AdminUsers = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition-all"
            />
          </div>
          <select
            value={roleFilter}
            onChange={(e) => setRoleFilter(e.target.value)}
            className="px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-amber-500 outline-none"
          >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-700 dark:border-slate-600 text-slate-500 dark:text-slate-400 text-xs uppercase tracking-wider">
              ...
              {isLoading ? (
                ...
                filteredUsers.map(u => {
                  ...
                  <tr key={u.id} className={`transition-colors ${isSelected ? 'bg-amber-50 dark:bg-amber-900/10' : 'hover:bg-slate-50 dark:hover:bg-slate-700/30'}`}>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full overflow-hidden bg-slate-100 dark:bg-slate-800 dark:bg-slate-700 flex items-center justify-center flex-shrink-0 border border-slate-200 dark:border-slate-700 dark:border-slate-600">
                          {u.profile_pic ? (
                            <img src={u.profile_pic} alt={u.name} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                          ) : (
                            <span className="text-slate-500 dark:text-slate-400 font-bold">{(u.name || 'User').charAt(0).toUpperCase()}</span>
                          )}
                        </div>
                        <div>
                    ...
                    <td className="px-6 py-4">
                      {u.googleId ? (
                        ...
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700">
                          ✉️ Email
                        </span>
                      )}
                    </td>
        ...
        <div className="px-6 py-3 border-t border-slate-100 dark:border-slate-800 dark:border-slate-700 text-xs text-slate-500 dark:text-slate-400">
      ...
      {viewingUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 dark:border-slate-700 flex justify-between items-center sticky top-0 bg-white dark:bg-slate-900 dark:bg-slate-800 z-10">
            ...
            <div className="p-6 space-y-6">
              {/* Profile Card */}
              <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-2xl p-4">
                <div className="w-20 h-20 rounded-2xl overflow-hidden bg-slate-200 flex items-center justify-center text-3xl font-black text-slate-500 dark:text-slate-400 flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    {viewingUser.googleId ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400">✉️ Email</span>
                    )}
                  </div>
                </div>
              </div>
              ...
              {/* Tab Navigation */}
              <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide border-b border-slate-100 dark:border-slate-800 dark:border-slate-700">
                {[
                    ...
                    {viewTab === 'overview' && (
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                          <div className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-3">
                        ...
                        <div>
                          ...
                          {userDetails.orders.length === 0 ? (
                            <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl text-center">No orders found.</p>
                          ) : (
                    ...
                    {viewTab === 'addresses' && (
                      <div className="space-y-3">
                        {userDetails.addresses.length === 0 ? (
                          <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl text-center">No addresses saved.</p>
                        ) : (
                          userDetails.addresses.map(addr => (
                            <div key={addr.id} className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-4 border border-slate-200 dark:border-slate-700 dark:border-slate-600 relative">
                              ...
                              <p className="font-bold text-slate-900 dark:text-white mb-1">{addr.fullName} <span className="text-sm font-normal text-slate-500 dark:text-slate-400 ml-2">{addr.addressType}</span></p>
                              ...
                              <p className="text-xs font-bold text-slate-500 dark:text-slate-400 flex items-center gap-1"><Phone className="w-3 h-3" /> {addr.phone}</p>
                              ...
                              <div className="flex gap-2 mt-3 pt-3 border-t border-slate-200 dark:border-slate-700 dark:border-slate-600">
                      ...
                      <div className="space-y-4">
                          ...
                          {userDetails.sessions.length === 0 ? (
                            ...
                            <div className="space-y-4">
                              {userDetails.sessions.map(s => (
                                <div key={s.id} className="border border-slate-200 dark:border-slate-700 dark:border-slate-600 rounded-2xl overflow-hidden shadow-sm bg-white dark:bg-slate-900 dark:bg-slate-700">
                                  <div className="p-4 flex items-center justify-between border-b border-slate-100 dark:border-slate-800 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50">
                                    <div className="flex items-center gap-4">
                                      <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600">
                                  ...
                                  <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-8">
                                    {[
                                      ...
                                      <div key={k} className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800 dark:border-slate-600 last:border-0">
                        ...
                        <div>
                          ...
                          {userDetails.loginActivities.length === 0 ? (
                            <p className="text-sm text-slate-500 dark:text-slate-400 italic">No login history.</p>
                          ) : (
                            <div className="space-y-2">
                              {userDetails.loginActivities.slice(0, 10).map(la => (
                                <div key={la.id} className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-3">
                                  ...
                                  <p className="text-xs text-slate-500 dark:text-slate-400">{la.ip_address} • {la.device_type} • {la.browser}</p>
                                </div>
                              ))}
                            </div>
                          )}
                    ...
                    {viewTab === 'wishlist' && (
                      <div className="space-y-3">
                        {userDetails.wishlist.length === 0 ? (
                          <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl text-center">Wishlist is empty.</p>
                        ) : (
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {userDetails.wishlist.map(item => (
                              <div key={item.id} className="flex gap-3 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-3 items-center">
                                <img src={(item.Product.images && item.Product.images[0]) || 'https://via.placeholder.com/50'} alt="product" className="w-12 h-12 rounded-lg object-cover bg-white dark:bg-slate-900" />
                    ...
                    {viewTab === 'reviews' && (
                      <div className="space-y-3">
                        {userDetails.reviews.length === 0 ? (
                          <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl text-center">No reviews submitted.</p>
                        ) : (
                          userDetails.reviews.map(r => (
                            <div key={r.id} className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <img src={(r.Product?.images && r.Product.images[0]) || 'https://via.placeholder.com/30'} alt="prod" className="w-8 h-8 rounded object-cover bg-white dark:bg-slate-900" />
                    ...
                    {viewTab === 'tickets' && (
                      <div className="space-y-3">
                        {userDetails.tickets.length === 0 ? (
                          <p className="text-sm text-slate-500 dark:text-slate-400 italic bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl text-center">No support tickets opened.</p>
                        ) : (
                          userDetails.tickets.map(t => (
                            <div key={t.id} className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 rounded-xl p-4">
              ...
              {/* Action Buttons */}
              <div className="flex gap-3 pt-2 border-t border-slate-100 dark:border-slate-800 dark:border-slate-700">
                <button
      ...
      {editingUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 dark:border-slate-700 flex justify-between items-center sticky top-0 bg-white dark:bg-slate-900 dark:bg-slate-800 z-10">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <form onSubmit={handleUpdateSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition-all"
                    required
                  />
                </div>
                <div>
                ...
                <div className="pt-4 flex gap-3 border-t border-slate-100 dark:border-slate-800 dark:border-slate-700">
                  <button
                    type="button"
                    onClick={() => setEditingUser(null)}
                    className="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 font-bold text-slate-600 dark:text-slate-400 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
      ...
      {addressToDelete && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 dark:border-slate-700 flex justify-between items-center bg-red-50 dark:bg-red-900/20">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 p-4 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 text-center">
                <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">Type this code to confirm</p>
              ...
              <input
                ...
                maxLength={4}
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white text-center text-lg font-black tracking-widest focus:border-red-400 focus:ring-2 focus:ring-red-100 outline-none"
              />
      ...
      {isAddingUser && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <form onSubmit={handleAddSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="password" required value={addFormData.password} onChange={(e) => setAddFormData({ ...addFormData, password: e.target.value })}
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition-all" placeholder="Enter password" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Role</label>
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 dark:border-slate-700 flex gap-3">
                  <button type="button" onClick={() => setIsAddingUser(false)}
                    className="flex-1 px-4 py-2.5 bg-slate-100 dark:bg-slate-800 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl font-medium hover:bg-slate-200 transition-colors">
                    Cancel
                  </button>
          ...
          <div className="bg-white dark:bg-slate-900 dark:bg-slate-800 rounded-3xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleUpdateAddress} className="p-6 space-y-4">
              <div>
                ...
                <input type="text" value={editingAddress.fullName} onChange={e => setEditingAddress({ ...editingAddress, fullName: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Street Address</label>
                <input type="text" value={editingAddress.street} onChange={e => setEditingAddress({ ...editingAddress, street: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">City</label>
                  <input type="text" value={editingAddress.city} onChange={e => setEditingAddress({ ...editingAddress, city: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">State</label>
                  <input type="text" value={editingAddress.state} onChange={e => setEditingAddress({ ...editingAddress, state: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Pincode</label>
                  <input type="text" value={editingAddress.pincode} onChange={e => setEditingAddress({ ...editingAddress, pincode: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
                </div>
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1">Phone</label>
                  <input type="text" value={editingAddress.phone} onChange={e => setEditingAddress({ ...editingAddress, phone: e.target.value })} className="w-full px-4 py-2 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-700 border-none rounded-xl" required />
                </div>
              </div>
              <div className="pt-4 flex gap-3">
                <button type="button" onClick={() => setEditingAddress(null)} className="flex-1 px-4 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl font-bold">Cancel</button>
