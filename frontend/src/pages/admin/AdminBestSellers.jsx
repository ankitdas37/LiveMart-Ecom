    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Best Sellers</h1>
            <p className="text-sm text-slate-500">Manage which products appear in the Best Sellers section on the home page</p>
          </div>
        </div>
      </div>

      {/* Search */}
      <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center flex-wrap gap-4">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="py-4 px-6 text-sm font-semibold text-slate-600">Product</th>
                  <th className="py-4 px-6 text-sm font-semibold text-slate-600">Price</th>
                  <th className="py-4 px-6 text-sm font-semibold text-slate-600">Status</th>
                  <th className="py-4 px-6 text-sm font-semibold text-slate-600 text-right">Best Seller</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {filteredProducts.map((product) => (
                  <tr key={product.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <p className="font-medium text-slate-900">₹{product.discount_price || product.price}</p>
                    </td>
                    <td className="py-4 px-6">
