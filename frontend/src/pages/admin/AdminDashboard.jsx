  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Welcome back to your store's admin panel.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-slate-900">{stats.orders.total}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-slate-900">{stats.totalCustomers}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-slate-900">{stats.lowStockCount}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-slate-900">{stats.orders.pending}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 mb-1">Confirmed Orders</p>
              <h3 className="text-3xl font-bold text-slate-900">{stats.orders.confirmed}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-3xl font-bold text-slate-900">{stats.orders.cancelled}</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
           ...
           <div className="space-y-3">
             <Link to="/admin/products/new" className="block w-full text-left px-4 py-2.5 rounded-lg border border-slate-200 hover:border-amber-500 hover:text-amber-600 transition-colors font-medium text-slate-700 flex items-center">
               <Package className="w-4 h-4 mr-3 text-slate-400" /> Add Product
             </Link>
             <Link to="/admin/categories" className="block w-full text-left px-4 py-2.5 rounded-lg border border-slate-200 hover:border-amber-500 hover:text-amber-600 transition-colors font-medium text-slate-700 flex items-center">
            ...
            <tbody className="divide-y divide-slate-100">
              {stats.recentOrders.map((order) => (
                <tr key={order.id} className="hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-900">#{'LIVEMART' + order.id.toString().padStart(6, '0')}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">{order.customer_name}</td>
